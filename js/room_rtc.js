const APP_ID = "bc6bacdf2b8e4b03a1089728bc1acbd2"
...
let joinRoomInit = async () =>{
    ...
    getMembers()
    addBotMessageToDom(`歡迎${displayName}加入房間!`)
    ...
    if(!rooms.includes(roomId)){
        rooms.push(roomId)
        await rtmClient.addOrUpdateChannelAttributes(roomId, {'room_name':roomName, 'host':displayName})
        hostExist = true
    }
    await rtmClient.addOrUpdateChannelAttributes('home', {'rooms':JSON.stringify(rooms)})
